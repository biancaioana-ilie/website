...
- LEDs: 
Connected via PWM (Pulse Width Modulation) pins on the Pico. Instead of just turning on and off, PWM allows the Pico to control the leds, enabling the pulsing "thinking" effect.
